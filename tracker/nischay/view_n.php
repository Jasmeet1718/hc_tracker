...
<body>
<?php if($_SESSION["role"]==='6' || $_SESSION["role"]==='5' || $_SESSION["role"]==='9'){
        if($_SESSION["role"]==='6' || $_SESSION["role"]==='9'){
            ?> <button><a href="./nischay.php">Back</a></button> 
            <?php
        }
        else if($_SESSION["role"]==='5'){ ?> <button><a href="../logout.php">Logout</a></button> <?php }
        
    $mail_id=$_SESSION["username"] ?>
    <div class="box">
        <h1 class="heading">Nischay Team</h1>
        <table class="tables">
            <tr>
                <th>Task assigned</th>
                <th>Assets Link</th>
        ...
        <?php 
        $sqlv="SELECT * FROM nischay_team WHERE mail_id='$mail_id' AND status='1'";
        ...
        $task_name2=$tt[0];
        $temp_tbd2=$tt[1];
            $sql17="SELECT * FROM assign_task WHERE assign_to='Nischay' AND task_name='$task_name2' AND temp_tbd='$temp_tbd2'";
        ...
        ?>
            ...
            <tr>
                ...
                <td><a href="prev_ads_n.php?id=<?php echo $submit_id ?>"><button name="deviation">Submit</button></a></td>
            </tr>
            <script>
    ...
    <div class="box2">
        ...
        <table class="tables">
            ...
            <?php $sqlvp="SELECT * FROM nischay_team WHERE mail_id='$mail_id' AND status='0'";
        ...
        $task_name=$tt[0];
        $temp_tbd=$tt[1];
            $sql1718="SELECT * FROM assign_task WHERE assign_to='Nischay' AND task_name='$task_name' AND temp_tbd='$temp_tbd'";
        ...
        ?>
            <tr>
                ...
                $str="start".$idp;
                if(isset($_POST[$str])){
                    $sql100="SELECT * FROM `nischay_team` WHERE name='$sername'";
                ...
                if(strpos($u, "1") !== false){
                    ?> <script>alert("Complete your on going task")</script> <?php
                     ...
                     $sqlu="UPDATE `nischay_team` SET `status`='1' WHERE id=$idp";
