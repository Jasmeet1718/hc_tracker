...
<body>
    ...
    <div class="main_contanier">
        <div class="assign_box">
            <div class="task_btn">
                <a href="yettoassign_l.php"><button>Yet to assign Task</button></a> 
                <a href="queue_l.php"><button>In queue Task</button></a> 
                <button>Ongoing Task</button>
                <a href="completel.php"><button>Completed Task</button></a> 
                <a href="view_l.php"><button>View your Task</button></a>
            </div>
            <table>
    <tr>
        <th>Name</th>
