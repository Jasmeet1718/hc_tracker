...
<body>
    <?php if($_SESSION["role"]==='7' || $_SESSION["role"]==='9'){

    if($_SESSION["role"]==='9'){ ?> <button><a href="./lakshya.php">Back</a></button>  <?php } 
    ...
    ?>
        ...
        <a href="asset_l.php"> <button class="submit">Submit</button></a>
    </div>
